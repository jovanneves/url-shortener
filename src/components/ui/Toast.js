 ...
 * @param {string} [props.type='success'] - Tipo da notificação: 'success', 'error', 'warning', 'info'
 * @param {number} [props.duration=3000] - Duração em milissegundos
...
export default function Toast({ 
  ...
  // Configuração de ícones e cores para cada tipo
  const toastConfig = {
    success: {
      icon: (
  ...
  return (
    <div 
      className={`
        ...
        flex items-center border-l-4 ${config.borderColor}
      `}
      role="alert"
    >
      <div className="mr-3">
      ...
      <button 
        ...
        className="text-gray-400 hover:text-gray-800 dark:hover:text-gray-200 focus:outline-none"
        aria-label="Fechar"
      >
